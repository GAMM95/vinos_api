...
public class PrecioMapperUtil {
  ...
  public static void mapPrecioStockBase (PrecioDTO pv, ResultSet rs) throws SQLException {
  ...
  public static void mapPrecioDetallado(PrecioDTO v, ResultSet rs) throws SQLException {
