...
//  //  Queries para cajas de cada usuario
//  private static final String COUNT_MIS_CAJAS = "SELECT COUNT(*) FROM vw_caja WHERE idUsuario = ?";
//  private static final String VW_MIS_CAJAS = "SELECT * FROM vw_caja WHERE idUsuario = ?";
//  // Queries para el total de cajas
//  private static final String COUNT_CAJAS = "SELECT COUNT(*) FROM vw_caja";
//  private static final String VW_CAJAS = "SELECT * FROM vw_caja";
//  // Query para consultar la ultima caja abierta de cada usuario
//  private static final String VW_ULTIMA_CAJA_ABIERTA = "SELECT * FROM vw_ultima_caja_abierta_usuario WHERE idUsuario = ?";
//
...
//  private ResultadoSP ejecutarSP(
//      int tipo,
//      Integer idCaja,
//      Integer idSucursal,
//      Integer idUsuario,
...
//    return ejecutarSP(1, null, caja.getSucursal().getIdSucursal(), caja.getUsuario().getIdUsuario(), caja.getSaldoInicial(), null, null, null, null);
//  }
//
//  @Override
//  public ResultadoSP cerrarCaja(Integer idCaja) {
//    return ejecutarSP(2, idCaja, null, null, null, null, null, null, null);
//  }
//
//  @Override
//  public ResultadoSP filtrarMisCajasPorRango(Integer idUsuario, LocalDate fechaInicio, LocalDate fechaFin, int pagina, int limite) {
//    return ejecutarSP(3, null, null, idUsuario, null, fechaInicio, fechaFin, pagina, limite);
//  }
//
//  @Override
//  public ResultadoSP filtrarTotalCajasPorRango(Integer idUsuario, LocalDate fechaInicio, LocalDate fechaFin, int pagina, int limite) {
//    return ejecutarSP(4, null, null, idUsuario, null, fechaInicio, fechaFin, pagina, limite);
//  }
//
//  @Override
//  public long contarMisCajasPorRango(Integer idUsuario, LocalDate fechaInicio, LocalDate fechaFin) {
//    String sql = COUNT_MIS_CAJAS + " AND fechaApertura >= ? AND fechaCierre < DATE_ADD(?, INTERVAL 1 DAY) ";
//    Long total = jdbcTemplate.queryForObject(sql, Long.class, idUsuario, fechaInicio, fechaFin);
//    return total != null ? total : 0;
//  }
//
//  @Override
//  public long contarTotalCajasPorRango(Integer idUsuario, LocalDate fechaInicio, LocalDate fechaFin) {
//    String sql = COUNT_CAJAS + " WHERE idUsuario = ? AND fechaApertura >= ? AND fechaCierre < DATE_ADD(?, INTERVAL 1 DAY) ";
//    Long total = jdbcTemplate.queryForObject(sql, Long.class, idUsuario, fechaInicio, fechaFin);
//    return total != null ? total : 0;
//  }
//
...
//    Map<String, Object> params = new HashMap<>();
//    params.put("pTipo", 5);
//    params.put("pIdCaja", null);
//    params.put("pIdSucursal", null);
//    params.put("pIdUsuario", null);
//    params.put("pSaldoInicial", null);
//    params.put("pFechaInicio", null);
//    params.put("pFechaFin", null);
//    params.put("pPagina", null);
//    params.put("pLimite", null);
//
...
//    String codCaja = (String) out.get("pCodCaja");
//
//    Map<String, Object> data = new HashMap<>();
//    data.put("codCaja", codCaja);
//
